...
- `docs/04-delivery/exec-plans/EXEC-007-milestone-reconciliation.md`: staged canonical contradiction proof and durable PM reconciliation; Stages 1-2 merged, Stage 3 candidate validation.
- `docs/05-quality/MILESTONE_CONSISTENCY_VALIDATION.md`: historical kernel/disclosure evidence and current durable-request validation limits; story acceptance remains pending.
