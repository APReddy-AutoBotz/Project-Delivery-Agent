...
| STORY-035 | EPIC-10 | **Implement shadow mode.** Suppress all configured external side effects while retaining proposals and logs. | P0 | FR-APP-010, FR-ADM-009, FR-CON-012, BR-011, PR-014 |
