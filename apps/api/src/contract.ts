...
export const contracts: Record<string, RouteContract> = {
  ...
  "get /api/projects/{id}/facts/{factType}/reconciliation-context": {
    status: 200,
    response: scalarReconciliationContextSchema,
    parameters: { id: z.uuid(), factType: humanStatementSchema.shape.factType },
    errors: [404, 503],
  },
  "post /api/projects/{id}/facts/{factType}/reconciliation-checks": {
    status: 201,
    request: scalarReconciliationCheckRequestSchema,
    response: scalarReconciliationCheckResultSchema,
    parameters: { id: z.uuid(), factType: humanStatementSchema.shape.factType },
    errors: [404, 409, 503],
  },
  "get /api/projects/{id}/scalar-reconciliation-requests/manage": {
    status: 200,
  ...
  "post /api/projects/{id}/scalar-reconciliation-requests/{requestId}/assignment": {
    status: 201,
    request: scalarReconciliationAssignmentRefreshSchema,
    response: reconciliationAssignmentResultSchema,
    parameters: { id: z.uuid(), requestId: z.uuid() },
    errors: [404, 409, 503],
  },
  "post /api/projects/{id}/scalar-reconciliation-requests/{requestId}/resolve": {
    status: 201,
    request: scalarReconciliationResolveSchema,
    response: scalarReconciliationCheckResultSchema,
    parameters: { id: z.uuid(), requestId: z.uuid() },
    errors: [404, 409, 503],
  },
